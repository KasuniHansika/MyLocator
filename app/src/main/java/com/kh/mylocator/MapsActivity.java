...
import com.kh.mylocator.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    CameraPosition cameraPosition = new CameraPosition.Builder()
                            ...
                            .zoom(17)
                            .build();
                    //addOverlay(new LatLng(currentLocation.getLatitude(), currentLocation.getLongitude()));
                    mMap.moveCamera(CameraUpdateFactory.newCameraPosition(cameraPosition));
                    drawMarker(location, "Your Current location");
                }
            }
        });
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        markerOptions.position(sriLanka);
